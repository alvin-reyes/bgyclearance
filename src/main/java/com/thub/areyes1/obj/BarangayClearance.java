...
public class BarangayClearance {
	...
	/**
	 * Checks if is for new.
	 *
	 * @return true, if is for new
	 */
	...
	/**
	 * Checks if is for renewal.
	 *
	 * @return true, if is for renewal
	 */
	...
	/**
	 * Sets the for renewal.
	 *
	 * @param forRenewal the new for renewal
	 */
	...
	/**
	 * Checks if is corporation.
	 *
	 * @return true, if is corporation
	 */
	 ...
	 *
	 * @param corporation the new corporation
	 */
	...
	/**
	 * Checks if is single proprietorship.
	 *
	 * @return true, if is single proprietorship
	 */
	...
	/**
	 * Sets the single proprietorship.
	 *
	 * @param singleProprietorship the new single proprietorship
	 */
	...
	/**
	 * Checks if is parntership.
	 *
	 * @return true, if is parntership
	 */
	...
	/**
	 * Sets the parntership.
	 *
	 * @param parntership the new parntership
	 */
