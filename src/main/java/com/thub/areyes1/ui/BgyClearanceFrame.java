...
public class BgyClearanceFrame extends JFrame {
	...
	public BgyClearanceFrame() {
		...
		btnNew.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				newRegistrationDialog = (JDialog)appContext.getBean(BgyClearanceRegistrationDialog.class);
		...
		JScrollPane jscrollPane = new JScrollPane(table,JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
	...
	/**
	 * Gets the all bgy clearances.
	 *
	 * @return the all bgy clearances
	 */
	 ...
	 *
	 * @param applicationContext the new spring application context
	 */
